...
data1 <- read_excel("fall_1.xlsx", col_types = c("text", "text", "numeric", "text", "text", "text", "date", "text", "text", "text", "text", rep("text", 31)))
data1$FECHA_FALLECIMIENTO<-as.Date(data1$FECHA_FALLECIMIENTO,format="%d/%m/%Y")
data2 <- read_excel("fall_2.xlsx", col_types = c("text", "text", "numeric", "text", "text", "text", "date", "text", "text", "text", "date", rep("text", 15)))
...
poblacion <- read_csv("estructura_de_poblacion_identificada_residiendo_en_argentina.csv",
                      col_types = cols(
...
death_data7c$grupo_etario<-factor(death_data7c$grupo_etario,levels=c("0-2","3-11","12-17"))
#Change grupo_etario levels to "0-2 years old","3-11 years old","12-17 years old"
levels(death_data7c$grupo_etario)<-c("0-2 years old","3-11 years old","12-17 years old")
